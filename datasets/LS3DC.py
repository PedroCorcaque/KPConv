...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Handle LS3DC dataset in a class
#
# ----------------------------------------------------------------------------------------------------------------------
#
...
class LS3DCDataset(Dataset):
    """ 
    Class to handle LS3DC dataset for segmentation task.
    """
    ...
    def __init__(self, input_threads=8):
        ...
        self.test_path = join(self.path, "ply_full/valid")
    ...
    def prepare_data(self):
        """
        Download and precompute LS3DC point clouds
        """

...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Callable script to start a training on LS3DC dataset
#
# ----------------------------------------------------------------------------------------------------------------------
#
#      Pedro L. CORÇAQUE - 27/12/2023
#
...
# Dataset
from datasets.LS3DC import LS3DCDataset
...
class LS3DCConfig(Config):
    ...
    # Number of classes in the dataset (This value is overwritten by dataset class when initialing input pipeline.)
    num_classes = None
...
if __name__ == "__main__":
    ...
    dataset = LS3DCDataset(config.input_threads)
